    ...
    public partial class MainDataWindow3 : Window
    {
        ...
        private void ButtonAddCombo_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    bool flag1 = MainDataWindow.Data_Check(dateOfDeregistration);
                    if (!flag1)
                    {
                ...
                if (dateOfDead != "")
                {
                    bool flag2 = MainDataWindow.Data_Check(dateOfDead);
                    if (!flag2)
                    {
                ...
                if (dataOfRegistration != "")
                {
                    bool flag3_ = MainDataWindow.Data_Check(dataOfRegistration);
                    if (flag3_)
                    {
                ...
                {
                    bool flag3_ = MainDataWindow.Data_Check(reRegistrationData);
                    if (flag3_)
                    {
                        string[] mas = data.Split('.', ',', '/');
                ...
                bool flag3 = MainDataWindow.Year_Check(dataInfo);
                if (!flag3)
                {
                ...
                if (check == true)
                {
                    Entity.Patient_Сreation_Alco_Narco(fio, sex, data, regionCenterBLR, raenCentrBLR, life, age, familyStatus,
                    ...
                    ageOfDead, ageOfRegistration, dataInfo);
                    Close();
                }
                else
                {
